...
<div *ngIf="response" class="bg-info">{{ response }}</div>
</div>
</div>
    `,
    styles: [`
...
export class UserDetailsComponent {
    ...
    login() {
        ...
        this.http.post("http://sr:8080/oauth/token", creds, {headers: headers})
            .subscribe(
                response => {
    ...
    getUser() {
        ...
        this.http.get("http://sr:8080/user", {headers: headers})
            .subscribe(
                response => {
