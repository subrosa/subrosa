...
import com.subrosagames.gateway.auth.JpaUsersConnectionRepository;
import com.subrosagames.gateway.auth.SocialUserRepository;
...
public class SocialAuthConfiguration extends SocialConfigurerAdapter {
    ...
    public UserIdSource getUserIdSource() {
        return () -> {
            ...
            return ((SubrosaUser) authentication.getPrincipal()).getUsername();
        };
    }
