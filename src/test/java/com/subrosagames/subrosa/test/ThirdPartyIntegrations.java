...
public class ThirdPartyIntegrations {
    ...
    private static class MockFacebookAdapter implements ApiAdapter<Facebook> {
        @Override
        ...
        public UserProfile fetchUserProfile(Facebook api) {
            ...
            builder.setEmail("peter@framptonindustries.com");
            builder.setUsername("peterframpton69");
