...
public final class QueryHelper {
     ...
     */
    public <T> TypedQuery<T> createQuery(EntityManager entityManager, Class<T> type, final Object id, String... expansions) {
        Map<String, Object> map = new HashMap<String, Object>() {{ put("id", id); }};
     ...
     * @return a typed query to retrieve the model
     */
    public <T> TypedQuery<T> createQuery(EntityManager entityManager, Class<T> type, Map<String, Object> conditions, String... expansions) {
